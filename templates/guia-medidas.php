...
<head>
    ...
    <link rel="stylesheet" href="../static/css/style-medidas.css">
    ...
    <main>
        <div class="container-body">
            <div class="container-text">
                ...
                <div class="body-text">
                    <h2>Confira as medidas das nossas Calças!</h2>
                    <p>Tabela de medidas das calças Jeans, Lisas, Contrasts e Tácteis:</p>
                </div>
            </div>
            <div class="body-img">
                <img src="../static/images/medidas.jpeg" alt="">
            </div>
        </div>
    </main>
